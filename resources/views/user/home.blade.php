...
@section('content')
    ...
    <section class="mt-6 px-6" id="content">
        <div class="container w-full flex flex-row">
            <div class="basis-8/12">

                <div class="flex flex-row gap-4 bg-responsive px-6 py-8 w-full h-64 z-10 blur-container my-2 rounded-2xl"
                    style="background-image: url({{ url($movie['second_banner']) }})">
                    <div class="blur-overlay"></div>
                    <div class="basis-3/12">
                        <img class="h-full max-w-xs rounded-lg drop-shadow-2xl shadow-lg inline-block content"
                    ...
                    <div class="relative basis-9/12 px-6">
                        ...
                        <div class="flex flex-row justify-between items-center mt-5">
                            <p style="width: 30ch" class="text-white movie-description">{{ $movie['info'] }} ...</p>
                            <a href="movie/{{ $movie['slug'] }}"
                ...
                <div class="w-full">
                    <div class="flex flex-wrap  bg-responsive  py-3 w-full z-10 blur-container my-2 rounded-2xl ">
                        ...
                        @foreach ($lastMovies as $movie)
                            <a href="movies/{{ ($movie['slug']) }}" class="lg:w-1/4 md:w-1/3 sm:w-1/2 w-full relative released-div mt-4 px-3">
                                ...
                                <div
                                    class="absolute bottom-5 z-20 justify-center  text-center  released-score-view">
